...
with open('../2/postgres_perf_metrics.csv', 'r') as csvfile:
...
limit_time = end_time + timedelta(minutes=25)
...
plt.title('PostgreSQL protsessori ja vahemälu kasutus ajas, 2 virtuaalkasutajat', fontsize=12)
