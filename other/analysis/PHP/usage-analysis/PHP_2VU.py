...
with open('../2/php_fpm_perf_metrics.csv', 'r') as csvfile:
...
limit_time = end_time + timedelta(minutes=2)
...
ax1.grid()
plt.title('PHP protsessori ja vahemälu kasutus ajas, 2 virtuaalkasutajat', fontsize=12)
