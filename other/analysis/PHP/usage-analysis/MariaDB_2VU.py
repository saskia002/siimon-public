...
with open('../2/maria_db_perf_metrics.csv', 'r') as csvfile:
...
limit_time = end_time + timedelta(minutes=5)
...
plt.title('MariaDB andmebaasi protsessori ja vahemälu kasutus ajas, 2 virtuaalkasutajat', fontsize=12)
